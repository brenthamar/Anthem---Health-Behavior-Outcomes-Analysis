...
*RECORD COUNT GOES FROM 32,969 TO 21,785;
...
*USING THE STANDARD DEFINITION IN THE THRESHOLD COMPARISON SPREADSHEET;
if stress_composite_First > 18 then Risk_First = 1;
if stress_composite_Last > 18 then Risk_Last = 1;
...
*15,307 RECORDS WERE UPDATED WITH A COUNT OF 2019 ELIG MONTHS;
proc sql;
